...
class DistanceAngleController:
    ...
    Features:
    - Captures and procesxqses video frames at a specified interval to reduce computation load.
    ...
    def __init__(self):
        ...
        self.target_distance = 0.5      # distance to maintain from user in meters
        ...
        self.angle_tolerance = 25        # acceptable angle deviation in degrees
    ...
    def control_movement(self, distance, horizontal_offset, frame_width, print_type):
    ...
    def start_tracking(self, print_type):
        while True:
...
if __name__ == "__main__":
    ser = serial.Serial('/dev/tty.usbserial-022680BC', 9600)
    estimator = DistanceAngleController()
    estimator.set_reference_distance()
    estimator.start_tracking(print_type="pwm")  # choose "pwm" or "movement